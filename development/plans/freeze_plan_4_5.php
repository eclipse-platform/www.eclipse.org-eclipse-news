...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "Eclipse Mars 4.5 Endgame Plan";
	$pageKeywords	= "eclipse, 4.5, milestone, schedule, endgame, Mars";
	$pageAuthor		= "";
...
<style type="text/css">
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>June 8 - Post RC4 builds will only occur if required to meet translation, documentation and Mars goals.</b></p>
      	</div>
		<div class="homeitem3col">
	        ...
	        <table class="schedule" border="0" cellspacing="0" cellpadding="0" align="center">
	          ...
	          <tr>
	            <td align="right" height="20"><b>May 2015</b>&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20"></td>
	          ...
	          <tr>
	            <td align="right" height="20"><b>June 2015</b>&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20"></td>
	          </tr>
			  ...
			  <tr class="current">
				...
				<td align="right" height="20"></td>
	            <td align="right" height="20"></td>
	            <td height="20"><b>Post RC4 builds will only occur if required to meet translation, documentation and Mars goals.
	          ...
	          <tr>
	            ...
	            <td align="right" height="20"></td>
	            <td height="20">&nbsp;&nbsp;<b>Release 4.5 available</b></td>
	            <td height="20">&nbsp;&nbsp;</td>
	            <td height="20">&nbsp;&nbsp;<b><a href="#Release4.5"><img src="../images/jump_in_black.gif" border="0" hspace="3" width="12" height="10"> details</a></b></td>
	            <td height="20">&nbsp;&nbsp;</td>
	          </tr>
	        </table>
      	</div>
		<div class="homeitem3col">
			...
			<li><a href="http://www.eclipse.org/projects/project-plan.php?projectid=eclipse">Eclipse Project Mars Plan</a></li>
			<li><a href="http://wiki.eclipse.org/Mars/Simultaneous_Release_Plan">Mars Simultaneous Release</a></li>
			</ul>
      	</div>
		<div class="homeitem3col">
			<h3>What is the game plan?</h3>
	        <p>The Eclipse 4.5 release endgame involves a sequence of test/fix
	        passes leading to the official 4.5 release. Even more than at other
	        ...
	        <p><b><a name="FixPass"></a>Fix Pass</b> - After each test pass, we analyze 
	          ...
	          are tagged accordingly (e.g., a bug tagged as Target 4.5 RC1 should 
		...
		<div class="homeitem3col">
			<h3 id="holidays">Holidays</h3>
				...
				<ul>
					<li>May  14 - Switzerland</li>
					<li>May  18 - Canada</li>
					<li>May  25 - Switzerland</li>
					<li>May  25 - United States</li>
					<li>June  4 - Poland</li>
				</ul>
				</p>
			<h3>Details</h3>
			<h4><a name="Transition"></a>Transition to fix and polish</h4>
      		<ul>
                <li>All components transition on May 6 to polishing and fixing 
		...
		<div class="homeitem3col">
			...
			<a name="FixPassAfterRC1"></a><h4>May 19-22 - contributions to RC2</h4>
			<p><b>Focus:</b> (1) P1 defects, (2) performance defects, (3) special 
              &quot;polish&quot; items. Fixing other defects has lower priority.</p>
            <p><b>Fix approval:</b> Two additional committers must +1 your bug report. All changes 
              must have their associated bug reports tagged 4.5 RC2. Ongoing changes 
              to component documentation do not require special approval.
              <br>
              No bugs must appear in <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced;classification=Eclipse;classification=RT;resolution=FIXED;target_milestone=4.5%20RC2;target_milestone=Mars%20RC2;field0-0-0=flagtypes.name;type0-0-0=notsubstring;value0-0-0=review%2B;field0-1-0=keywords;type0-1-0=notsubstring;value0-1-0=documentation;field0-2-0=keywords;type0-2-0=notsubstring;value0-2-0=test;field0-3-0=keywords;type0-3-0=notsubstring;value0-3-0=example;field0-4-0=status_whiteboard;type0-4-0=notsubstring;value0-4-0=routine%20releng;list_id=1368548">this query</a>.
			...
			<a name="FixPassAfterRC2"></a><h4>May 26-29 - contributions to RC3</h4>
            ...
            <p><b>Fix approval:</b> Two additional committers and a component lead must +1 your bug report (3 people who are not the one making the change). All changes 
              must have their associated bug reports tagged 4.5 RC3. Ongoing changes 
              to component documentation do not require special approval.
              <br>
              No bugs must appear in <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced;classification=Eclipse;classification=RT;resolution=FIXED;target_milestone=4.5%20RC3;target_milestone=Mars%20RC3;field0-0-0=flagtypes.name;type0-0-0=notsubstring;value0-0-0=review%2B;field0-1-0=keywords;type0-1-0=notsubstring;value0-1-0=documentation;field0-2-0=keywords;type0-2-0=notsubstring;value0-2-0=test;field0-3-0=keywords;type0-3-0=notsubstring;value0-3-0=example;field0-4-0=status_whiteboard;type0-4-0=notsubstring;value0-4-0=routine%20releng;list_id=1368548">this query</a>.
              When your bug appears there, make sure that it gets the review+ flags or add the 'Documentation', 'example' or 'test' keyword if appropriate.</p>
             <p><b>Feature work and API change approval:</b> PMC must approve all feature work and API changes. No changes are to
              be released without prior approval and associated bug report.  
              Send the request for approval to the <a href="mailto:eclipse-pmc@eclipse.org">eclipse-pmc@eclipse.org</a> mailing list. 
			...
			<a name="FixPassAfterRC3"></a><h4>June 2-5 - contributions to RC4</h4>
			<p><b>Focus:</b> Serious defects only; documentation.</p>
            <p><b>Fix approval:</b> Component lead plus one other component lead must 
              ...
              associated bug report tagged 4.5 RC4 including risk assessment and 
              prior approvals. Ongoing changes to component documentation do 
              not require special approval.
              <br>
              No bugs must appear in <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced;classification=Eclipse;classification=RT;resolution=FIXED;target_milestone=4.5%20RC4;target_milestone=Mars%20RC4;field0-0-0=flagtypes.name;type0-0-0=notsubstring;value0-0-0=review%2B;field0-1-0=keywords;type0-1-0=notsubstring;value0-1-0=documentation;field0-2-0=keywords;type0-2-0=notsubstring;value0-2-0=test;field0-3-0=keywords;type0-3-0=notsubstring;value0-3-0=example;field0-4-0=status_whiteboard;type0-4-0=notsubstring;value0-4-0=routine%20releng;list_id=1368548">this query</a>.
              When your bug appears there, make sure that it gets the review+ flags or add the 'Documentation', 'example' or 'test' keyword if appropriate.</p>
             <p><b>Feature work and API change approval:</b> PMC must approve all feature work and API changes. No changes are to
              be released without prior approval and associated bug report.  
              Send the request for approval to the <a href="mailto:eclipse-pmc@eclipse.org">eclipse-pmc@eclipse.org</a> mailing list. 
