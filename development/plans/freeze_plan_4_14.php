...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2019-11-17
	#
	# Description: Eclipse project 4.14 release freeze plan
	#
	#
	#****************************************************************************
	...
	$pageTitle 		= "Eclipse 2019-12 (4.14) Endgame Plan";
	$pageKeywords	= "eclipse, 4.14, 2019-12, milestone, schedule, endgame";
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>Sunday, November 17: Working towardss M3 next Friday</b></p>
      	</div>
		<div class="homeitem3col">
	        ...
	        <table class="schedule" border="0" cellspacing="0" align="center" width=100%>
	          ...
	          <tr>
	            ...
	            <td></td>
	            <td></td>
	            <td>Two daily I-builds starting on 25th</td>
	            <td></td>
	          </tr>
			  <tr>
	            <td class="spacer">&nbsp;</td>
		...
		<div class="homeitem3col">
			...
			<li><a href="https://www.eclipse.org/projects/project-plan.php?planurl=http://www.eclipse.org/eclipse/development/plans/eclipse_project_plan_4_14.xml">Eclipse Project 4.14 Plan</a></li>
			<li><a href="https://wiki.eclipse.org/Category:SimRel-2019-12">2019-12 Simultaneous Release</a></li>
			</ul>
      	</div>
		<div class="homeitem3col">
			<h3>What is the game plan?</h3>
			<p> 
	 		The Eclipse 2019-12 (4.14) release endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        2019-12 (4.14) release. The Eclipse project version number for this release is 4.14.
			As always, we welcome help from the 
	        community with testing the release candidates. All new features and problems fixed in 2019-12 (4.14) are in the Eclipse bugzilla database.
	        </p> 

	        <p>General announcements during the 2019-12 (4.14) endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for 2019-12 (4.14). At the end of RC2 build, 
	        there should not be any open defects tagged 4.14. All fixes submitted 
			...
			<strong>2019-12 (4.14) Release</strong>
			<p>The 2019-12 (4.14) release should be complete and available for download by 
	              December 18, 2019 as part of the <a href="https://wiki.eclipse.org/Category:SimRel-2019-12">2019-12 Simultaneous Release</a>. If product teams intending 
	              to ship on 2019-12 (4.14) uncover further serious defects during the endgame, 
