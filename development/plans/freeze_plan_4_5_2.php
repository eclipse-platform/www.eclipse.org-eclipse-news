...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2015-11-26
	#
	# Description: Eclipse project 4.5.2 release freeze plan
	#
	#
	#****************************************************************************
	...
	$pageTitle 		= "Eclipse Mars.2 (4.5.2) Endgame Plan";
	$pageKeywords	= "eclipse, 4.5.2, SR2, milestone, schedule, endgame";
	$pageAuthor		= "";
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>Weekly maintenance builds until December 31</b></p>
      	</div>
		<div class="homeitem3col">
			<h3>Detailed Timeline</h3>
	        <table class="schedule" border="0" cellspacing="0" align="center" width=100%>
	          <tr class="current">
	            <td>Until December 31, 2015</td>
	          </tr>
	          <tr>
	            <td></td>
	            <td></td>
	          ...
	          <tr>
	            ...
	            <td class="date">Fri</td>
	            <td></td>
	            <td>Simultaneous release train GA Mars.2</td>
	            <td></td>
	          </tr>
	        </table>
			<p>
			...
			<ul>
				<li>January 29 - Mars M5</li>
				<li>February 15 - Canada</li>
			</ul>
			</p>
      	</div>
		<div class="homeitem3col">
			...
			<li><a href="http://wiki.eclipse.org/index.php/Mars">Mars Simultaneous Release</a></li>
			</ul>
      	</div>
		<div class="homeitem3col">
			<h3>What is the game plan?</h3>
			<p> 
	 		The Eclipse Mars Service Release 2 ("Mars.2 (4.5.2)") endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        Mars.2 (4.5.2) release. The Eclipse project version number for this release is 4.5.2.
	        By its nature, this maintenance release contains fixes to a small number 
	        of serious problems found in the June 2015 Mars (4.5) release. We make and verify each 
	        ...
	        community with testing the release candidates. By default, Mars.2 (4.5.2)
	        is supposed to work exactly like the initial Mars (4.5) release except for the problems we intended 
	        to fix. All problems fixed in Mars.2 (4.5.2) are in the Eclipse bugzilla database 
	        and flagged with Target Milestone &quot;4.5.2&quot; (query bugzilla for 
	        the <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced;resolution=FIXED;target_milestone=4.5.2&target_milestone=Mars%20SR2;product=Equinox;product=JDT;product=PDE;product=Platform;classification=Eclipse;classification=RT">complete 
	        list of bugs fixed in Mars.2 (4.5.2)</a>). So we're most interested in identifying 
	        regressions where we've changed something that we did not intend to.
	        </p> 

	        <p>General announcements during the Mars.2 (4.5.2) endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for Mars.2 (4.5.2). At the end of RC2 build, 
	        there should not be any open defects tagged 4.5.2. All fixes submitted 
	        to maintenance stream builds must have a component lead or PMC vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
	        </p>      
	        ...
	        that we intend to fix for Mars.2 (4.5.2). All fixes submitted to RC3 must have a PMC vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
			...
			<strong>Mars.2 (4.5.2) Release</strong>
			<p>The Mars.2 (4.5.2) release should be complete and available for download by 
	              the end of February 2016 as part of the <a href="http://wiki.eclipse.org/Mars">Mars 
	              coordinated service release</a> . If product teams intending 
	              to ship on Mars.2 (4.5.2) uncover further serious defects during the endgame, 
