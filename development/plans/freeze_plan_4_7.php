...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "Eclipse Oxygen 4.7 Endgame Plan";
	$pageKeywords	= "eclipse, 4.7, milestone, schedule, endgame, Oxygen";
	$pageAuthor		= "";
...
<style type="text/css">
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>June 8 - 1-day test pass against RC4 and sign-off.</b></p>
      	</div>
		<div class="homeitem3col">
	        ...
	        <table class="schedule" border="0" cellspacing="0" cellpadding="0" align="center">
	          ...
	          <tr>
	            <td align="right" height="20"><b>May 2017</b>&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20"></td>
	          ...
	          <tr>
	            <td align="right" height="20"><b>June 2017</b>&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20"></td>
	          </tr>
			  ...
			  <tr>
				...
				<td align="right" height="20"></td>
	            <td align="right" height="20"></td>
	            <td height="20"><b>Post RC4 builds will only occur if required to meet translation, documentation and Oxygen goals.
	          ...
	          <tr>
	            ...
	            <td align="right" height="20"></td>
	            <td height="20">&nbsp;&nbsp;<b>Release 4.7 available</b></td>
	            <td height="20">&nbsp;&nbsp;</td>
	            <td height="20">&nbsp;&nbsp;<b><a href="#Release4.7"><img src="../images/jump_in_black.gif" border="0" hspace="3" width="12" height="10"> details</a></b></td>
	            <td height="20">&nbsp;&nbsp;</td>
	          </tr>
	        </table>
      	</div>
		<div class="homeitem3col">
			...
			<li><a href="http://wiki.eclipse.org/Oxygen/Simultaneous_Release_Plan">Oxygen Simultaneous Release</a></li>
			</ul>
      	</div>
		<div class="homeitem3col">
			<h3>What is the game plan?</h3>
	        <p>The Eclipse 4.7 release endgame involves a sequence of test/fix
	        passes leading to the official 4.7 release. Even more than at other
	        ...
	        <p><b><a name="FixPass"></a>Fix Pass</b> - After each test pass, we analyze 
	          ...
	          are tagged accordingly (e.g., a bug tagged as Target 4.7 RC1 should 
		...
		<div class="homeitem3col">
			...
			<a name="FixPassAfterRC1"></a><h4>May 22 - 24 - contributions to RC2</h4>
			<p><b>Focus:</b> (1) P1 defects, (2) performance defects, (3) special 
              &quot;polish&quot; items. Fixing other defects has lower priority.</p>
			...
			<a name="FixPassAfterRC2"></a><h4>May 29 - 31 - contributions to RC3</h4>
