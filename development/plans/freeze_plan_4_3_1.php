...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2013-09-16
	#
	# Description: Eclipse project 4.3.1 release freeze plan
	#
	#
	#****************************************************************************
	...
	$pageTitle 		= "Kepler 4.3 SR1 Endgame Plan";
	$pageKeywords	= "eclipse, 4.3.1,  milestone, schedule, endgame";
	$pageAuthor		= "";
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>September 16, 2013 - RC4 is done. Further builds for show stoppers only on request.</b></p>
      	</div>
		<div class="homeitem3col">
			...
			<ul>
				<li>August 9 - Bangalore, India</li>
				<li>August 15 - Poland and Bangalore, India</li>
				<li>September 2 - Canada and United States</li>
				<li>Afternoon of September 9 - Zurich, Switzerland</li>
				<li>September 9 - Bangalore, India</li>
			</ul>
			</p>
      	</div>
		<div class="homeitem3col">
		...
		<div class="homeitem3col">
			...
			<p> 
	 		The Eclipse Kepler 4.3 Service Release 1 ("Kepler 4.3 SR1") endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        Kepler 4.3 SR1 release. The Eclipse project version number for this release is 4.3.1.
	        By its nature, this maintenance release contains fixes to a small number 
	        of serious problems found in the June 2013 Kepler 4.3 release. We make and verify each 
	        ...
	        community with testing the release candidates. By default, Kepler 4.3 SR1
	        is supposed to work exactly like the initial Kepler 4.3 release except for the problems we intended 
	        to fix. All problems fixed in Kepler 4.3 SR1 are in the Eclipse bugzilla database 
	        and flagged with Target Milestone &quot;4.3.1&quot; (query bugzilla for 
	        the <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced;resolution=FIXED;target_milestone=4.3.1;product=Equinox;product=JDT;product=PDE;product=Platform;classification=Eclipse;classification=RT">complete 
	        list of bugs fixed in Kepler 4.3 SR1</a>). So we're most interested in identifying 
	        regressions where we've changed something that we did not intend to.
	        </p> 

	        <p>General announcements during the Kepler 4.3 SR1 endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for Kepler 4.3 SR1. At the end of RC2 build, 
	        there should not be any open defects tagged 4.3.1. All fixes submitted 
	        to maintenance stream builds must have a component lead vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
	        </p>               
	        ...
	        that we intend to fix for Kepler 4.3 SR1. All fixes submitted to RC3 must have a PMC vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
			...
			<strong>Kepler 4.3 SR1 Release</strong>
			<p>The Kepler 4.3 SR1 release should be complete and available for download by 
	              the end of September 2013 as part of the <a href="http://wiki.eclipse.org/Kepler">Kepler 
	              coordinated service release</a> . If product teams intending 
	              to ship on Kepler 4.3 SR1 uncover further serious defects during the endgame, 
