...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2019-02-18
	#
	# Description: Eclipse project 4.11 release freeze plan
	#
	#
	#****************************************************************************
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>March 7, 2019 - 1-day test pass against RC2 and sign-off</b></p>
      	</div>
		<div class="homeitem3col">
		...
		<div class="homeitem3col">
			...
			<li><a href="https://www.eclipse.org/projects/project-plan.php?planurl=http://www.eclipse.org/eclipse/development/plans/eclipse_project_plan_4_11.xml">Eclipse Project 4.11 Plan</a></li>
			<li><a href="https://wiki.eclipse.org/Category:SimRel-2019-03">2019-03 Simultaneous Release</a></li>
			</ul>
      	</div>
		<div class="homeitem3col">
			<h3>What is the game plan?</h3>
			<p> 
	 		The Eclipse 2019-03 (4.11) release endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        2019-03 (4.11) release. The Eclipse project version number for this release is 4.11.
			As always, we welcome help from the 
	        community with testing the release candidates. All new features and problems fixed in 2019-03 (4.11) are in the Eclipse bugzilla database.
	        </p> 

	        <p>General announcements during the 2019-03 (4.11) endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for 2019-03 (4.11). At the end of RC2 build, 
	        there should not be any open defects tagged 4.11. All fixes submitted 
			...
			<strong>2019-03 (4.11) Release</strong>
			<p>The 2019-03 (4.11) release should be complete and available for download by 
	              March 20, 2019 as part of the <a href="https://wiki.eclipse.org/Category:SimRel-2019-03">2019-03 Simultaneous Release</a>. If product teams intending 
	              to ship on 2019-03 (4.11) uncover further serious defects during the endgame, 
