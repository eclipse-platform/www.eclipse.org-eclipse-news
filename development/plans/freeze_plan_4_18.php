...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2020-11-17
	#
	# Description: Eclipse project 4.18 release freeze plan
	#
	#
	#****************************************************************************
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			...
			<li><a href="https://www.eclipse.org/projects/project-plan.php?planurl=http://www.eclipse.org/eclipse/development/plans/eclipse_project_plan_4_18.xml">Eclipse Project 4.18 Plan</a></li>
			<li><a href="https://wiki.eclipse.org/Category:SimRel-2020-12">2020-12 Simultaneous Release</a></li>
			</ul>
      	</div>
		<div class="homeitem3col">
			<h3>What is the game plan?</h3>
			<p> 
	 		The Eclipse 2020-12 (4.18) release endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        2020-12 (4.18) release. The Eclipse project version number for this release is 4.18.
			As always, we welcome help from the 
	        community with testing the release candidates. All new features and problems fixed in 2020-12 (4.18) are in the Eclipse bugzilla database.
	        </p> 

	        <p>General announcements during the 2020-12 (4.18) endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for 2020-12 (4.18). At the end of RC2 build, 
	        there should not be any open defects tagged 4.18. All fixes submitted 
