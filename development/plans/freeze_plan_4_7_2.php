...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "Eclipse Oxygen Update 2 (4.7.2) Endgame Plan";
	$pageKeywords	= "eclipse, 4.7.2, Update 2, milestone, schedule, endgame";
	$pageAuthor		= "";
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>Submitted RC4 to release train.</b></p>
      	</div>
		<div class="homeitem3col">
	        ...
	        <table class="schedule" border="0" cellspacing="0" align="center" width=100%>
	          ...
	          <tr>
	            ...
	            <td class="date">Fri</td>
	            <td></td>
	            <td>Simultaneous release train GA Oxygen.2</td>
	            <td></td>
	          </tr>
	          <tr>
	            <td class="spacer">&nbsp;</td>
		...
		<div class="homeitem3col">
			...
			<p> 
	 		The Eclipse Oxygen Service Release 2 ("Oxygen Update 2 (4.7.2)") endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        Oxygen Update 2 (4.7.2) release. The Eclipse project version number for this release is 4.7.2.
	        ...
	        community with testing the release candidates. By default, Oxygen Update 2 (4.7.2)
	        is supposed to work exactly like the initial Oxygen (4.7) release except for the problems we intended 
	        to fix. All problems fixed in Oxygen Update 2 (4.7.2) are in the Eclipse bugzilla database 
	        and flagged with Target Milestone &quot;4.7.2&quot; (query bugzilla for 
	        the <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced;resolution=FIXED;target_milestone=4.7.2;product=Equinox;product=JDT;product=PDE;product=Platform;classification=Eclipse;classification=RT">complete 
	        list of bugs fixed in Oxygen Update 2 (4.7.2)</a>). So we're most interested in identifying 
	        regressions where we've changed something that we did not intend to.
	        </p> 

	        <p>General announcements during the Oxygen Update 2 (4.7.2) endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for Oxygen Update 2 (4.7.2). At the end of RC2 build, 
	        there should not be any open defects tagged 4.7.2. All fixes submitted 
	        ...
	        that we intend to fix for Oxygen Update 2 (4.7.2). All fixes submitted to RC3 must have a PMC vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
			...
			<strong>Oxygen Update 2 (4.7.2) Release</strong>
			<p>The Oxygen Update 2 (4.7.2) release should be complete and available for download by 
	              the end of December 2017 as part of the <a href="https://wiki.eclipse.org/Oxygen/Simultaneous_Release_Plan#Oxygen.2">Oxygen 
	              coordinated service release</a> . If product teams intending 
	              to ship on Oxygen Update 2 (4.7.2) uncover further serious defects during the endgame, 
