...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2010-12-03
	#
	# Description: Eclipse project 4.1.2 release freeze plan
	#
	#
	#****************************************************************************
	...
	$pageTitle 		= "4.1.2 Endgame Plan";
	$pageKeywords	= "eclipse, 4.1.2,  milestone, schedule, endgame";
	$pageAuthor		= "";
...
<style type="text/css">
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>October 21, 2011 - working towards release candidate 1.</b></p>
      	</div>
		<div class="homeitem3col">
		...
		<div class="homeitem3col">
			...
			<p> 
	 		The Eclipse 4.1.2 endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        4.1.2 release. The Eclipse project version number for this release is 4.1.2.
	        By its nature, this maintenance release contains fixes to a small number 
	        of serious problems found in the September 2011 4.1.1 release. We make and verify each 
	        ...
	        community with testing the release candidates. By default,&nbsp; 4.1.2
	        is supposed to work exactly like the initial 4.1 release except for the problems we intended 
	        to fix. All problems fixed in 4.1.2 are in the Eclipse bugzilla database 
	        and flagged with Target Milestone &quot;4.1.2&quot; (query bugzilla for 
	        the <a href="http://bugs.eclipse.org/bugs/buglist.cgi?product=JDT&amp;product=PDE&amp;product=Platform&amp;product=Equinox&amp;target_milestone=4.1.2&amp;resolution=FIXED&amp;order=bugs.bug_id">complete 
	        list of bugs fixed in 4.1.2</a>). We are most interested in identifying 
	        regressions where we have changed something that we did not intend to.
	        </p> 
	                
	        <p>General announcements during the 4.1.2 endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for 4.1.2. At the end of RC2 build, 
	        there should not be any open defects tagged 4.1.2. All fixes submitted 
	        to maintenance stream builds must have a component lead vote on the bug report,
	        ...
	        that we intend to fix for 4.1.2. All fixes submitted to RC3 must have a PMC vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
			...
			<strong>4.1.2 Release</strong>
			<p>The 4.1.2 release should be complete and available for download by 
	              the end of February 2012 as part of the <a href="http://wiki.eclipse.org/Indigo/Simultaneous_Release_Plan#SR2">4.1 
	              coordinated service release</a> . If product teams intending 
	              to ship on 4.1.2 uncover further serious defects during the endgame, 
