...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2015-08-12
	#
	# Description: Eclipse project 4.5.1 release freeze plan
	#
	#
	#****************************************************************************
	...
	$pageTitle 		= "Eclipse Mars SR1 (4.5.1) Endgame Plan";
	$pageKeywords	= "eclipse, 4.5.1, SR1, milestone, schedule, endgame";
	$pageAuthor		= "";
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h3>Status</h3>
			<p><b>August 12, 2015 - Release Candidate 1 build.</b></p>
      	</div>
		<div class="homeitem3col">
			...
			<ul>
				...
				<li>September 7 - Canada and United States</li>
				<li>Afternoon of September 14 - Zurich, Switzerland</li>
				<li>September 17 - Bangalore, India</li>
			</ul>
			</p>
      	</div>
		<div class="homeitem3col">
		...
		<div class="homeitem3col">
			...
			<p> 
	 		The Eclipse Mars Service Release 1 ("Mars SR1 (4.5.1)") endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        Mars SR1 (4.5.1) release. The Eclipse project version number for this release is 4.5.1.
	        ...
	        community with testing the release candidates. By default, Mars SR1 (4.5.1)
	        is supposed to work exactly like the initial Mars (4.5) release except for the problems we intended 
	        to fix. All problems fixed in Mars SR1 (4.5.1) are in the Eclipse bugzilla database 
	        and flagged with Target Milestone &quot;4.5.1&quot; (query bugzilla for 
	        the <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced;resolution=FIXED;target_milestone=4.5.1;product=Equinox;product=JDT;product=PDE;product=Platform;classification=Eclipse;classification=RT">complete 
	        list of bugs fixed in Mars SR1 (4.5.1)</a>). So we're most interested in identifying 
	        regressions where we've changed something that we did not intend to.
	        </p> 

	        <p>General announcements during the Mars SR1 (4.5.1) endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for Mars SR1 (4.5.1). At the end of RC2 build, 
	        there should not be any open defects tagged 4.5.1. All fixes submitted 
	        to maintenance stream builds must have a component lead or PMC vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
	        </p>      
	        ...
	        that we intend to fix for Mars SR1 (4.5.1). All fixes submitted to RC3 must have a PMC vote on the bug report,
	        and the fix must be reviewed by an additional committer (any committer other than
	        the one who made the fix).
			...
			<strong>Mars SR1 (4.5.1) Release</strong>
			<p>The Mars SR1 (4.5.1) release should be complete and available for download by 
	              the end of September 2015 as part of the <a href="http://wiki.eclipse.org/Mars">Mars 
	              coordinated service release</a> . If product teams intending 
	              to ship on Mars SR1 (4.5.1) uncover further serious defects during the endgame, 
