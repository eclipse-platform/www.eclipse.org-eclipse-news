<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2009-08-05
	#
	# Description: Eclipse project 3.5.1 release freeze plan
	#
	#
	#****************************************************************************
...
?>		
	...
	<div id="midcolumn">
		...
		<p><font color="#ff0000"><b>Wednesday Augst 5, 2008 15:00 EDT Status:</b></font> 
			The first release candidate is scheduled for this Friday August 7th.
		      </td></tr> 
		<tr> <td valign="top" align="left" colspan="2"><b>Detailed Timeline</b></td></tr> <tr> <td valign="top" align="left" colspan="2"> 
		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
          <TR> 
            <TD HEIGHT="18" ALIGN="right"><B>August 2009</B>&nbsp;</TD>
