...
<p><b>May 26-27, 2008 - Two day test pass against RC2</td></tr>
    <tr>
    ...
    <tr>
      <td valign="top" align="left" colspan="2">
        <table border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
            <td align="right" height="18"><b>May 2007</b>&nbsp;</td>
		  ...
		  <tr>
		   ...
		   <tr>
			...
			<td align="right" height="18"></td>
            <td align="right" height="18"></td>
            <td height="18">&nbsp;&nbsp;<b>documentation and Ganymede goals.</b></td>
            <td height="18">&nbsp;</td>          
            <td height="18">&nbsp;&nbsp;</td>
          </tr>
		   <tr>
    ...
    <tr>
      <td valign="top" align="right"><img src="images/Adarrow.gif" border="0" width="16" height="16"></td>
      <td>
        <p><a href="http://wiki.eclipse.org/index.php/Ganymede">Ganymede Simultaneous Release</a></p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="98%">
        <p>The Eclipse 3.4 release endgame involves a sequence of test/fix
        passes leading to the official 3.4 release. Even more than at other
    ...
    <tr>
      ...
      <td width="98%" height="63">
        <p><b><a name="FixPass"></a>Fix Pass</b> - After each test pass, we analyze 
          ...
          are tagged accordingly (e.g., a bug tagged as Target 3.4 RC1 should 
    ...
    <tr>
      ...
      <td>
        <table cellspacing="0" cellpadding="5" width="100%" border="1">
          <tr>
            <td width="25%">Goal:</td>
            <td width="75%">Ship Eclipse 3.4 during the last week of June.</td>
          </tr>
          <tr>
            <td width="25%">Notes:</td>
            <td width="75%">There is no formal test pass for RC4 and beyond other 
              ...
              checking focused on documentation. Release 3.4 should be complete 
        ...
        <table cellspacing="0" cellpadding="5" width="100%" border="1">
          ...
          <tr>
            ...
            <td width="75%">Another committer must +1 your bug report. All changes 
              must have their associated bug reports tagged 3.4RC1. (Ongoing changes 
        ...
        <table cellspacing="0" cellpadding="5" width="100%" border="1">
          ...
          <tr>
            ...
            <td width="75%" height="48">Two committers must +1 your bug report. 
              All changes must have their associated bug reports tagged 3.4RC2. 
        ...
        <table cellspacing="0" cellpadding="5" width="100%" border="1">
          ...
          <tr>
            ...
            <td width="75%"> Two committers and a component lead must +1 your 
              ...
              3.4RC3. (Ongoing changes to component documentation do not require 
              special approval.)</td>
          </tr>
          <tr>
            <td width="25%">API change approval:</td>
        ...
        <table cellspacing="0" cellpadding="5" width="100%" border="1">
          ...
          <tr>
            ...
            <td width="75%">Component lead plus one other component lead must 
              ...
              associated bug report tagged 3.4RC4 including risk assessment and 
