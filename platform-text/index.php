		...
		<div class="homeitem3col">
			<h3>What's Happening?</h3>
		      ...
		      <ul>
		        ...
		        <li> The plan for the current milestone is posted <a href="3.7/plan.php#Milestone_Planning_M2">here</a>.</li>
		        <li>The original plans for previous milestones can be found <a href="3.7/plan.php#Milestone_Planning_M1">here</a>.</li>
		      </ul></p>
			...
			<ul>
		      ...
		      <h4> <a NAME="Maintenance_Planning"></a>3.6 Maintenance</h4>
		      <p>Information about 3.6 maintenance releases can be found <a href="http://wiki.eclipse.org/Helios_Simultaneous_Release#Coordinated_Service_Releases">here</a> and
