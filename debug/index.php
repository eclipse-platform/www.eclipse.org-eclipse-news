	...
	<div id="midcolumn">
		...
		<div class="homeitem">
			...
			<ul>
				...
				<li style="list-style: url('/eclipse.org-common/themes/Nova/images/bullet.png') inside;"><a href="/eclipse/debug/test_plans/test_plans.php#3-5_testing">Debug 3.5 Test Matrix</a></li>
			</ul>
		</div>
	</div>
	<div id="rightcolumn">
