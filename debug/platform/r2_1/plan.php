...
<div id="maincontent">
		...
		<div class="homeitem3col">
	        ...
	        <ul>
	        	<li>Architectural issues 
	            	<ul>
	            		<li><img src="ok.gif"> synchronization/serialization of runnables</li>
	            		<li><img src="ok.gif"> &quot;plural&quot; listener interfaces for breakpoints, launches, and expressions</li>
	            		<li><img src="ok.gif"> vulnerability to runtime exceptions in extension points and listeners</li>
	            		<li><img src="ok.gif"> incorporate step debug into debug core interfaces </li>
	          		</ul>
	          	</li>
	        	<li>Performance 
	          		<ul>
	        	...
	        	<li>Actions 
	          		<ul>
	            		<li><img src="ok.gif"> Workbench key binding support</li>
	          		</ul>
	        	</li>
	        	<li>Launch configurations 
	          		<ul>
	            		<li><img src="ok.gif"> convenience action to open launch config dilaog from history menu (perhaps CTRL-click)</li>
	            		<li><img src="ok.gif"> dialog to support editing of single launch configuration</li>
	            		<li><img src="ok.gif"> support for launch configuration categories</li>
	            		<li><img src="ok.gif"> support for launch configuration groups</li>
	          		</ul>
	        	</li>
	        	<li>Variables 
	          		<ul>
	            		<li><img src="ok.gif"> support for multi-select details (i.e. details of more than one variable)</li>
	            		<li><img src="ok.gif"> support for wrapped details area rather than horizontal scrolling</li>
	            		<li><img src="ok.gif"> support for font selection in the details area</li>
	            		<li>migrate detail area location setting to view menu (as in type hierachy view)</li>
	            		<li><img src="ok.gif"> variables remain expanded on stack frame browsing</li>
	            		<li><img src="ok.gif"> variables remain expanded on iterative suspend/resume/suspend</li>
	          		</ul>
	        	</li>
	        	<li>Presentation 
	          		<ul>
	            		<li><img src="ok.gif"> show sticky instruction pointers (via markers or highlighting), in all visible stack frames</li>
	          		</ul>
	        	</li>
	        	<li>Console 
	          		<ul>
	            		<li><img src="ok.gif"> investigate extensible &quot;open&quot; 
	            		...
	            		<li><img src="ok.gif"> line tracker extension point 
	              		...
	              		as required.</li>
	            		<li><img src="ok.gif"> support for showing the output of a specific process without debug view interaction</li>
	          		</ul>
	        	</li>
		        <li>Breakpoints 
		          	<ul>
		            	<li><img src="ok.gif" height=10 width=10> use platform support for selective persistence of breakpoints</li>
	              	</ul>
		        <li>Source lookup 
		          	<ul>
		            	<li><img src="ok.gif" height=10 width=10> &quot;Source not found&quot; 
		              	editor - opened when source is not located for the selected stack frame </li>
		          	</ul>
		        </li>
		        <li>Articles 
		          	<ul>
		            	<li><img src="ok.gif" height=10 width=10> We Have Liftoff: The Launching Framework in Eclipse</li>
		          	</ul>
		        </li>
			</ul>
	...
	<div class="homeitem3col">
		...
		<ul>
	        ...
	        <li>Console 
	          	<ul>
	            	<li><img src="ok.gif" height=10 width=10> Support for showing the output of a specific process with drop-down menu </li>
	          	</ul>
	        </li>
	        <li>Architecture 
	          	<ul>
	            	<li><img src="ok.gif" height=10 width=10> Protect againt exceptions in listener lists and extension points</li>
	          	</ul>
	        </li>
	        <li>Actions 
	          	<ul>
		            <li><img src="ok.gif" height=10 width=10> Workbench key binding support</li>
		            <li><b>[Deferred]</b> Improve start-up performance of contributed toggle actions in debug views (lazy activation)</li>
		            <li><img src="ok.gif" height=10 width=10> Support for new &quot;step debug&quot; interface/action</li>
	          	</ul>
	        </li>
	        <li>Variables 
	          	<ul>
		            <li><img src="ok.gif" height=10 width=10> Support for wrappered details area</li>
		            <li><img src="ok.gif" height=10 width=10> Support for font selection in the details area</li>
	          	</ul>
	        </li>
	        <li>Launch Configurations 
	          	<ul>
		            <li><img src="ok.gif" height=10 width=10> Remove support for working set filters in launch dialog</li>
		            <li><img src="ok.gif" height=10 width=10> Support for editing &amp; launching a single configuration from the dialog (for external tools/ant)</li>
	          	</ul>
	        </li>
	     </ul>
	</div>
