<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			August 25, 2006
	#
	# Description: This page outlines the debug project 3.2 test matrix
	#
	#
	#****************************************************************************
	
	
	$pageTitle 		= "Debug Project 3.2 Test Matrix";
		...
		<div class="homeitem3col">
			...
			<h4>Breakpoints</h4>
				<ul>
				  ...
				  <li>Creation of different types of breakpoints. 
				    <ul>
				      <li>Toggle Line breakpoints - double click in ruler, Run menu action (menu 
				        &amp; keybinding)</li>
				      <li>Toggle Method breakpoints - Run menu action (menu &amp; acclerator) 
				        <ul>
				          <li>can be used in editor and editor outline</li>
				        </ul>
				      </li>
				      <li>Togggle Watchpoints - Run menu action (menu &amp; acclerator) 
				        <ul>
				          <li>can be used in editor and editor outline</li>
				        </ul>
				      </li>
				      <li>Exception Breakpoints - Run menu action, hyperlink from stack trace</li>
				      <li>Class Load Breakpoint - Run menu, Toggle action from editor outline 
				      </li>
				    </ul>
				  </li>
				  <li>Refactorings</li>
				  ...
				  <li>Option to delete breakpoints vs. working set when &quot;delete&quot; pressed 
				    on a working set</li>
				  <li>Preference for suspending VM by default on newly created breakpoints</li>
				</ul>
			<p><a href="#top">Back to top</a><br><hr></p>
			<a name="Run"></a>
			<h4>Run to Line </h4>
			...
			<h4>Execution Environments</h4>
				<ul>
				  <li>Specifying a build path via EE 
				    <ul>
				      <li>Changing the default JRE for an EE updaetes buildpath</li>
				    </ul>
				  </li>
				  <li>Specifying a runtime JRE via EE 
				    <ul>
				      <li>Changing the default JRE for an EE updaetes runtime JRE</li>
				    </ul>
				  </li>
				</ul>
			<p><a href="#top">Back to top</a><br><hr></p>
			<a name="String"></a> 
			<h4>StringVariables </h4>
				<ul>
