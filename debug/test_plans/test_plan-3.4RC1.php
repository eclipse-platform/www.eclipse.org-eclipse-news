<?php 
	...
	$pageTitle 		= "Debug Project 3.4RC1 Test Matrix";
	$pageKeywords	= "debug, platform, debugging, debugger, breakpoints, launching, test, testing, matrix, plan, 3.4, RC1";
...
<div id="maincontent">
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h2><b>Testers</b></h2>
			<p>Committers: Darin Wright, Michael Rennie, Curtis Windatt, Samantha Chan (Kevin Jiang will substitute for Sam for RC1), Pawel Piech</p>
			<p>Community: Kevin Jiang, Anyone who wants to help</p>
		</div>
		<div class="homeitem3col">
			<h2><b>JRE Grid</b></h2>
			  ...
			  <div align="center">
				<table width="90%" border="1">
				  ...
				  <tr> 
				    ...
				    <td> <div align="center">&nbsp;</div></td>
				    <td> <div align="center">&nbsp;</div></td>
				    <td> <div align="center">Kevin Jiang</div></td>
				    <td> <div align="center">&nbsp;</div></td>
					<td> <div align="center">&nbsp;</div></td>
				  </tr>
				  <tr> 
		...
		<div class="homeitem3col">
			...
			<table width="90%" border="1">
			  <tr> 
			    ...
			    <td width="12%" align="center"><b>Pawel Piech</b></td>
			     <td width="12%" align="center"><b>Kevin Jiang</b></td>
			  </tr>
			  <tr> 
			...
			<table width="90%" border="1">
			  <tr> 
			    ...
			    <td width="15%"><b>Kevin Jiang</b></td>
