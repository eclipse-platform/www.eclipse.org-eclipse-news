<?php 
	...
	$pageTitle 		= "Debug Project 3.5M7 Test Matrix";
	$pageKeywords	= "debug, platform, debugging, debugger, breakpoints, launching, test, testing, matrix, plan, 3.x, 3.5, 3.5M7, M7";
