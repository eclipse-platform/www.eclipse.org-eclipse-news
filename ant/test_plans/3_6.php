<?php  	
	...
	# Date:			August 10, 2009
	#
	# Description: Test plan for 3.6
	#
	#
	#****************************************************************************
	
	
	$pageTitle 		= "Platform Ant 3.6 Test Matrix";
	$pageKeywords	= "ant, script, platform, debugging, debugger, breakpoints, launching, test, plan, release, testing, tester, 3.6";
	$pageAuthor		= "Ant Team";
