<?php  	
	...
	#
	# Description: Ant test matrix for 3.7M4
	#
	#
	#****************************************************************************
	
	
	$pageTitle 		= "Platform Ant 3.7M4 Project Test Matrix";
...
<div id="maincontent">
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			<h2><b>Testers</b></h2>
			<p>Committers: Darin Wright, Michael Rennie</p>
			<p>Community: Curtis Windatt and anyone who wants to help</p>
		</div>
		<div class="homeitem3col">
			<h2><b>JRE Grid</b></h2>
		...
		<div class="homeitem">
			...
			<p><a href="#top">Back to top</a><br><hr></p>
			<a name="headless_builds"></a>
			<h3>Headless Builds</h3>
				<ul>
					<li>Run a headless build, ensuring that:
					    <ul>
			...
			<p><a href="#top">Back to top</a><br><hr></p>
			<a name="headless_ext_tools"></a>
			<h3>Headless External Tools</h3>
				<ul>
					<li>Run a headless external tool, ensuring that
					    <ul>
